...
const changeMovieLogo = () => {
    ...
    switch(genreLogo) {
        case 'Action':
            return '<i class="fa fa-flash" style="font-size:135px;color:silver; align:center" ></i>';
        case 'Comedy':
            return '<i class="far fa-grin-squint-tears	&#xf586;" style="font-size:135px;color:yellow; align:center"></i>';
        case 'Drama':
            return '<i class="fas fa-theater-masks fa-7x" style="font-size:135px;color:orange; align:center"></i>';
        case 'Horror':
            return '<i class="fas fa-ghost fa-7x"style="font-size:135px;color:violet; align:center"></i>';
        case 'Romance':
            return '<i class="fas fa-heart fa-7x"style="font-size:135px;color:red; align:center"></i>';
        default:
            return '';
    }
}
